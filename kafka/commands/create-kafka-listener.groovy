description("Creates a listener class for Kafka") {
    usage "mn create-kafka-listener [LISTENER NAME]"
    argument name: 'Listener Name', description: "The name of the listener to create", required: true
    flag name: 'force', description: "Whether to overwrite existing files"
    flag name: 'lang', description: "The language used for the listener (options: groovy, kotlin, java)"
}

def model = model(args[0]).forConvention("Listener")
...
render template: template("${lang}/Listener.${extension}"),
